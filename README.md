...
![Architecture diagram showing Prompt Opinion → Gemini Orchestrator → specialist agents (Clinical Q&A, Drug Interaction, Renal Dosing) → MCP tools → FHIR, PubMed, and OpenFDA APIs](architecture.png)
